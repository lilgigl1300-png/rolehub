DICE&SOUL — новый современный стиль (конструктивизм) + авто TG + Google Sheets
==========================================================================
...
=== Новые страницы ===
- game.html — страница игры (карточка кликается)
- masters.html — каталог проверенных мастеров
- hire.html — страница «Найти мастера» (форма для мастеров)

=== GitHub Pages (project site) ===
Ты используешь формат https://username.github.io/rolehub/
Важно: оставляй относительные ссылки (index.html, assets/..., games.html) — так уже сделано.
